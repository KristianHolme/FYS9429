...
![Schematic of the Fourier Neural Operator. Adapted from [@li]](figures/fno.drawio.svg){#fig-fno}
...
Based on the results in [@fig-fno-modes-analysis; -@fig-fno-depth-analysis; -@fig-fno-width-analysis; and -@fig-fno-batch-analysis], we settled on a FNO configuration with 64 Fourier modes, a network depth, i.e. number of layers, of 4, a network width of 32, and a batch size of 256.
